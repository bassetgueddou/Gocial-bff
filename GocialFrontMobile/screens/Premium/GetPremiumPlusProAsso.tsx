...
const GetPremiumPlusProAsso: React.FC = () => {
    ...
    const plans: PlanType[] = [
        { duration: "12 mois", price: "23,99 €/mois" },
        { duration: "6 mois", price: "33,99 €/mois" },
        { duration: "3 mois", price: "43,99 €/mois" },
        { duration: "1 mois", price: "53,99 €/mois" },
    ];
...
export default GetPremiumPlusProAsso;
