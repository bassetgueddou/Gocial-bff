    ...
    return (
        <View className={`flex-1 ${isDarkMode ? "bg-black" : "bg-white"} pb-8`}>
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
                <MoreProfilModal visible={modalMoreProfilVisible} onClose={() => setModalMoreProfilVisible(false)} userId={userId} pseudo={profile?.pseudo || profile?.company_name} />
                <ScrollView className="flex-1">
                    <View className="relative">
                        ...
                        <SafeAreaView className="absolute top-0 left-0 right-0">
                            <View className="flex-row justify-between items-start px-4 pt-4">
                                ...
                                <TouchableOpacity onPress={() => setModalMoreProfilVisible(true)} className="bg-[#E8A838] px-4 py-2 rounded-lg">
                    ...
                    <View className="p-4">
                        <View className="flex-row items-center mb-3">
                            <MaterialIcons name="place" size={20} color="#E8A838" />
                ...
                <TouchableOpacity onPress={() => setModalExternalMessageVisible(true)} className={`${isDarkMode ? "bg-[#1A6EDE]" : "bg-[#065C98]"} px-6 py-3 rounded-lg mt-6 w-[90%] self-center`}>
