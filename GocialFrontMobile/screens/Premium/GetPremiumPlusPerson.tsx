...
const GetPremiumPlusPerson: React.FC = () => {
    ...
    const plans: PlanType[] = [
        { duration: "12 mois", price: "8,99 €/mois" },
        { duration: "6 mois", price: "11,99 €/mois" },
        { duration: "3 mois", price: "14,99 €/mois" },
        { duration: "1 mois", price: "17,99 €/mois" },
    ];
    ...
    return (
        <View className="flex-1">
            ...
            <View className={`${isDarkMode ? "bg-black" : "bg-white"} min-h-screen`}>
                ...
                <LinearGradient
                    colors={["#C3AE79", "#AC9A6B", "#5D533A"]}
                    locations={[0.32, 0.56, 1]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
                    style={{ width: "100%", height: 60, justifyContent: "center", alignItems: "center" }}
                >
                    <Text className="text-black text-lg font-bold">Gocial Premium</Text>
                </LinearGradient>
                ...
                {plans.map((plan, index) => (
                    <Pressable
                        key={index}
                        className={`w-[85%] flex-row justify-between items-center bg-gray-300 p-4 rounded-lg my-2 mx-auto ${selectedPlan === index ? "bg-[#5D533A]" : ""
                            }`}
            ...
            <View className={`${isDarkMode ? "bg-black" : "bg-white"} absolute bottom-0 left-0 right-0 p-4`}>
                ...
                <TouchableOpacity className="w-[90%] mx-auto my-5">
                    ...
                    >
                        <Text className="text-black font-bold text-lg">Valider</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
        </View>
...
export default GetPremiumPlusPerson;
