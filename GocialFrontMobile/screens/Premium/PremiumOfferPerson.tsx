...
const pricingOptions = [
    ...
    { option: "Ajouts d’amis par jour", premium: "5", premiumPlus: "10" },
    { option: "Participants max à tes activités", premium: "20", premiumPlus: "50" },
    { option: "Voir qui a vu mon profil", premium: "✔️", premiumPlus: "✔️" },
    { option: "Messages lus", premium: "✔️", premiumPlus: "✔️" },
...
const PremiumOfferPerson: React.FC = () => {
    ...
    return (
        <View className="flex-1">
            ...
            <View className={`absolute bottom-0 left-0 right-0 mb-2 ${isDarkMode ? "bg-black" : "bg-white"} p-4 flex-row justify-between items-center h-[100px]`}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("GetPremiumPerson")}>
                    <LinearGradient
...
export default PremiumOfferPerson;
