            ...
            >
                ...
                <ScrollView className="flex-1">
                    ...
                    <View className="relative">
                        ...
                        <SafeAreaView className="absolute top-0 left-0 right-0">
                            <View className="flex-row justify-between items-center px-4 pt-4">
                                ...
                                {/* Bouton "Asso" à droite */}
                                <TouchableOpacity onPress={() => setModalMoreProfilVisible(true)}  className="bg-[#008F29] px-4 py-2 rounded-lg">
                    ...
                    <View className="p-4">
                        ...
                        {/* Bouton Itinéraire */}
                        <TouchableOpacity className="bg-green-600 h-12 px-4 rounded-2xl w-[150px] justify-center items-center">
