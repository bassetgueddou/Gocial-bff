...
interface ExternalMessageModalProps {
    visible: boolean;
    onClose: () => void;
    partnerId: number;
    partnerName: string;
...
const ExternalMessageModal: React.FC<ExternalMessageModalProps> = ({ visible, onClose, partnerId, partnerName, partnerInitials }) => {
                    ...
                    <View className={`w-full h-[88%] ${isDarkMode ? "bg-black" : "bg-white"} rounded-t-2xl p-5`}>
                        <View className="flex-1">
                            <View className="mt-2 flex-row items-center">
                                <TouchableOpacity onPress={onClose} className="relative right-2">
                                    <MaterialIcons name="close" size={27} color={isDarkMode ? "white" : "black"} />
                                </TouchableOpacity>
