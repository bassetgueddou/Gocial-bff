...
const GetPremiumPerson: React.FC = () => {
    const { isDarkMode } = useTheme();
    const navigation = useNavigation<NavigationProp>();
    const [selectedPlan, setSelectedPlan] = useState<number | null>(null);

    const plans: PlanType[] = [
        { duration: "12 mois", price: "5,99 €/mois" },
        { duration: "6 mois", price: "8,99 €/mois" },
        { duration: "3 mois", price: "11,99 €/mois" },
        { duration: "1 mois", price: "15,99 €/mois" },
    ];
...
export default GetPremiumPerson;
