...
const ProfilPro: React.FC = () => {
    ...
    const lat = user.latitude || 48.872;
    const lng = user.longitude || 2.343;
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
                <ScrollView className="flex-1">
                    ...
                    <View className="mt-6 w-full">
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate("ProfilProPreview")} className={`${isDarkMode ? "bg-[#1A6EDE]" : "bg-[#065C98]"} px-6 py-3 rounded-lg mt-6 w-[90%] self-center`}>
