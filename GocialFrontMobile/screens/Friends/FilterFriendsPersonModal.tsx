...
interface FilterFriendsPersonModalProps {
    visible: boolean;
    onClose: () => void;
}
...
const FilterFriendsPersonModal: React.FC<FilterFriendsPersonModalProps> = ({ visible, onClose }) => {
                        ...
                        {!viewFavoriteActivityVisible ? (
                            ...
                            <>
                                ...
                                <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
                                    ...
                                    <View className={`${isDarkMode ? "bg-[#1D1E20]" : "bg-[#F2F5FA]"} py-4 px-6 flex-row flex-wrap gap-2 mb-6 w-full`}>
                                    ...
                                    <View className={`${isDarkMode ? "bg-[#1D1E20]" : "bg-[#F2F5FA]"} py-4 px-6 mt-1 w-full`}>
                                        ...
                                        <View className="flex-row justify-center mb-7 mr-[4rem]">
                                            ...
                                            <TouchableOpacity
                                                className={`px-4 py-2 rounded-lg ${selectedOption === "city" ? "bg-[#065C98] text-white" : isDarkMode ? "bg-black" : "bg-gray-300"
                                                    }`}
                                        ...
                                        {selectedOption === "city" && (
                                            <TextInput
                                                className={`border border-[#1D4E89] bg-white rounded-md w-full h-12 px-4 mb-6 ${isDarkMode ? "text-white" : "text-black"}`}
                                        ...
                                        {/* Texte Rayon */}
                                        <Text className={`text-center mb-8 ${isDarkMode ? "text-white" : ""}`}>Dans un rayon de {radius} kms</Text>
                                    ...
                                    <View className="flex-row items-center justify-between p-4 mt-4">
                                        <Text className={`text-base font-medium ${isDarkMode ? "text-white" : "text-black"}`}>Seulement les utilisateurs vérifiés</Text>
                                        <Image source={require("../../img/check.png")} className="h-5 w-5 relative right-2" />
                                        <Switch
                                            value={onlyFree}
...
export default FilterFriendsPersonModal;
