...
type RootStackParamList = {
    AddProfilePhotoPerson: { registerData: RegisterData };
    Login: undefined;
};

type NavigationProp = StackNavigationProp<RootStackParamList, "AddProfilePhotoPerson">;
type ScreenRouteProp = RouteProp<RootStackParamList, "AddProfilePhotoPerson">;
        ...
        <SafeAreaView className={`flex-1 ${isDarkMode ? "bg-black" : "bg-white"} px-6 justify-between`}>
            ...
            <View className="items-center mt-8">
                ...
                <Text className={`${isDarkMode ? "text-white" : "text-black"} text-center mt-4`}>
                    Nous te conseillons de mettre ton visage 😇
                </Text>
            </View>
