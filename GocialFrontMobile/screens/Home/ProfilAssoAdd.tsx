        ...
        <View className={`flex-1 ${isDarkMode ? "bg-black" : "bg-white"} pb-8`}>
            ...
            >
                    ...
                    <View className="relative">
                        ...
                        <SafeAreaView className="absolute top-0 left-0 right-0">
                            <View className="flex-row justify-between items-center px-4 pt-4">
                                ...
                                <TouchableOpacity
                                    onPress={() => setModalMoreProfilVisible(true)}
                                    className="bg-[#008F29] px-4 py-2 rounded-lg">
                ...
                <View className="flex-row justify-between mx-5 mt-2">
                    <TouchableOpacity onPress={() => setModalExternalMessageVisible(true)} className={`bg-green-500 px-6 py-3 rounded-lg w-[40%]`}>
