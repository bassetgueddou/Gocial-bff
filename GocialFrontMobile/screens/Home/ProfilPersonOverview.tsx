            ...
            >
                    ...
                    <View className="relative">
                        ...
                        <SafeAreaView className="absolute top-0 left-0 right-0">
                            <View className="flex-row justify-between items-center px-4 pt-4">
                                ...
                                <TouchableOpacity>
                                    <MaterialIcons onPress={() => setModalMoreProfilVisible(true)} name="more-horiz" size={30} color="black" />
                                </TouchableOpacity>
                            </View>
                        </SafeAreaView>
                ...
                <View className="flex-row justify-between mx-5 mt-2">
                    <TouchableOpacity onPress={() => {
                        ...
                        Toast.show({
                            type: isFriend ? 'error' : 'success',
                            text1: isFriend
                            ? 'Ami supprimé ❌'
                            : 'Ami ajouté ✅',
                            text2: isFriend
                            ? 'Cette personne a été retirée de tes amis.'
                            : 'Cette personne est maintenant dans tes amis.',
                            position: 'top',
                            topOffset: 60,
                        });
                    }}
                        className={`${isFriend ? "bg-[#FF0000]" : "bg-green-500"} px-6 py-3 rounded-lg w-[40%]`}>
                        <Text className="text-white font-semibold text-center">{isFriend ? 'Supprimer' : 'Ajouter'}</Text>
                    </TouchableOpacity>
