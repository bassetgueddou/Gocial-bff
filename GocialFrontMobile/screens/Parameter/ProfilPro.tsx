            ...
            >
                <ScrollView className="flex-1">
                    ...
                    <View className="relative">
                        ...
                        <SafeAreaView className="absolute top-0 left-0 right-0">
                            <View className="flex-row justify-between items-start px-4 pt-4">
                                ...
                                {/* Conteneur pour "Pro" et "Modifier" en colonne */}
                                <View className="flex-col items-end space-y-2">
                                    ...
                                    {/* Bouton Modifier */}
                                    <TouchableOpacity className={`${isDarkMode ? "bg-[#1A6EDE]" : "bg-[#065C98]"} flex-row items-center px-4 py-2 rounded-lg mt-1`}>
                    ...
                    <View className="p-4">
                        ...
                        {/* Bouton Itinéraire */}
                        <TouchableOpacity className={`${isDarkMode ? "border-[0.3px] border-white bg-black" : "bg-black"} h-12 px-4 rounded-2xl w-[150px] justify-center items-center`}>
